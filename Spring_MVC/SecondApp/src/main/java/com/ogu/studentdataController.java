...
public class studentdataController {
	@PostMapping("/save")
	public ModelAndView saveStudentInfo(HttpServletRequest req) {
	...
	public ModelAndView verify (HttpServletRequest req) {
		...
		if(email.equalsIgnoreCase("vloganathantech@gmail.com")&&pass.equalsIgnoreCase("loganathan.net.com")){
			view.setViewName("logedin.jsp");
		}else {
			view.setViewName("ronguser.jsp");
		}
		return view;
